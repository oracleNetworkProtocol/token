...
import (
	...
	"github.com/oracleNetworkProtocol/token/testutil/network"
	"github.com/oracleNetworkProtocol/token/x/token/client/cli"
)
...
func TestCreateToken(t *testing.T) {
	...
	fields := []string{"xyz", "xyz", "xyz", "xyz", "111", "xyz", "true"}
